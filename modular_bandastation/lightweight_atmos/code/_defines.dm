...
#define LIGHTWEIGHT_ATMOS_CLOUD_TEMP_EXCHANGE 0.004
...
#define AREA_AIR_VENT_TEMP_EXCHANGE 0.08

#define AREA_AIR_OUTDOOR_REGEN 0.5
#define AREA_AIR_INDOOR_DRIFT 0.0005
#define AREA_AIR_TEMP_DEFAULT T20C
#define AREA_AIR_TEMP_MIN TCMB
#define AREA_AIR_TEMP_MAX (T0C + 500)
#define AREA_AIR_TEMP_DRIFT 0.01
