// Cyberpunk modular override for code/game/machinery/computer/dna_console.dm.
	...
	switch(action)
		...
		if("makeup_injector")
			...
			switch(params["type"])
				...
				if("uf")
					if(!buffer_slot["name"] || !buffer_slot["UF"])
						to_chat(usr,span_warning("Genetic data corrupted, unable to create injector."))
						return
					stored_dna.real_name = buffer_slot["name"]
 ...
 */
/obj/machinery/computer/dna_console/apply_genetic_makeup(type, buffer_slot)
 ...
 */
/obj/machinery/computer/dna_console/scanner_operational()
 ...
 */
/obj/machinery/computer/dna_console/can_modify_occupant()
 ...
 */
/obj/machinery/computer/dna_console/connect_to_scanner()
 ...
 *
	...
	* is queued.
 */
/obj/machinery/computer/dna_console/on_scanner_close()
 ...
 */
/obj/machinery/computer/dna_console/on_scanner_open()
 ...
 */
/obj/machinery/computer/dna_console/build_genetic_makeup_list()
 ...
 */
/obj/machinery/computer/dna_console/build_mutation_list(can_modify_occ, mob/user)
 ...
 */
/obj/machinery/computer/dna_console/build_chrom_list(mutation)
...
/obj/machinery/computer/dna_console/get_mutation_class(datum/mutation/mutation)
 ...
 */
/obj/machinery/computer/dna_console/get_mut_by_ref(ref, target_flags)
	var/mutation
 ...
 */
/obj/machinery/computer/dna_console/randomize_GENETIC_DAMAGE_accuracy(position, pulse_duration, number_of_blocks)
 ...
 */
/obj/machinery/computer/dna_console/scramble(input,rs)
	...
	/**
	  ...
	  */
/obj/machinery/computer/dna_console/genetic_damage_pulse()
	// GUARD CHECK - Can we genetically modify the occupant? Includes scanner
	//  operational guard checks.
 ...
 */
/obj/machinery/computer/dna_console/set_default_state()
 ...
 */
/obj/machinery/computer/dna_console/eject_disk(mob/user)
	// Check for diskette.
	if(!diskette)
		return
...
/obj/machinery/computer/dna_console/set_connected_scanner(new_scanner)
	if(connected_scanner)
...
/obj/machinery/computer/dna_console/react_to_scanner_del(datum/source)
	set_connected_scanner(null)
