// Cyberpunk carbon life overrides kept outside core to reduce upstream merge conflicts.
...
/mob/living/carbon/breathe(seconds_per_tick)
...
/mob/living/carbon/handle_suffocation(breath_pp = 0, safe_breath_min = 0, true_pp = 0)
	. = 0
...
/mob/living/carbon/handle_blood(seconds_per_tick)
	return
...
/mob/living/carbon/handle_organs(seconds_per_tick)
	if(stat == DEAD)
 ...
 */
/mob/living/carbon/handle_dead_metabolization(seconds_per_tick)
	if(stat != DEAD)
		return
 ...
 * - times_fired: The number of times SSmobs has ticked
 */
/mob/living/carbon/natural_bodytemperature_stabilization(datum/gas_mixture/environment, seconds_per_tick)
	var/areatemp = get_temperature(environment)
...
**/
/mob/living/carbon/get_insulation_protection(temperature)
...
/mob/living/carbon/get_heat_protection(temperature)
	return heat_protection

/// This returns the percentage of protection from cold as a value from 0 - 1
/// temperature is the temperature you're being exposed to
/mob/living/carbon/get_cold_protection(temperature)
 ...
 */
/mob/living/carbon/share_bodytemperature(mob/living/carbon/M)
...
/mob/living/carbon/handle_liver(seconds_per_tick)
	if(isnull(has_dna()))
		return
...
/mob/living/carbon/undergoing_liver_failure()
	var/obj/item/organ/liver/liver = get_organ_slot(ORGAN_SLOT_LIVER)
...
/mob/living/carbon/handle_brain_damage(seconds_per_tick)
