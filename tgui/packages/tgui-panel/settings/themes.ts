...
export function setClientTheme(name): void | Promise<void> {
  ...
  return Byond.winset({
    ...
    'info_button_child.background-color': themeColor.BG_BASE,
    'info.background-color': themeColor.BG_BASE,
    'info.text-color': themeColor.TEXT,
    'info_split.background-color': themeColor.BG_BASE,
    'info_child.background-color': themeColor.BG_BASE,
    ...
    'output_selector_screen.background-color': themeColor.BG_BASE,
    'output_selector.background-color': themeColor.BG_BASE,
    'legacy_output_selector.background-color': themeColor.BG_BASE,
    ...
    'mapwindow.background-color': themeColor.BG_BASE,
    'input_buttons_child.background-color': themeColor.BG_BASE,
    'input_buttons.background-color': themeColor.BG_BASE,
    'inputbuttons.background-color': themeColor.BG_BASE,
    'inputwindow.background-color': themeColor.BG_BASE,
    // Buttons
