...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/datum/controller/subsystem/processing/station = list(
		...
		"STATION_TRAIT_XENOBUREAUCRACY_ERROR" = STATION_TRAIT_XENOBUREAUCRACY_ERROR, // BANDASTATION ADDITION: Xenobureacuracy error
	...
	/mob = list(
		...
		"TRAIT_CY_ANALGESIA_FAST" = TRAIT_CY_ANALGESIA_FAST,
		"TRAIT_CY_ANALGESIA_SLOW" = TRAIT_CY_ANALGESIA_SLOW,
		"TRAIT_CY_ANALGESIA_INSTANT" = TRAIT_CY_ANALGESIA_INSTANT,
		...
		"TRAIT_CY_POWER_MELEE_1" = TRAIT_CY_POWER_MELEE_1,
		"TRAIT_CY_POWER_MELEE_2" = TRAIT_CY_POWER_MELEE_2,
		"TRAIT_CY_POWER_MELEE_3" = TRAIT_CY_POWER_MELEE_3,
		"TRAIT_CY_POWER_MELEE_4" = TRAIT_CY_POWER_MELEE_4,
		"TRAIT_CY_POWER_MELEE_5" = TRAIT_CY_POWER_MELEE_5,
		"TRAIT_CY_POWER_MELEE_6" = TRAIT_CY_POWER_MELEE_6,
		"TRAIT_CY_HEAVY_WEAPONS_1" = TRAIT_CY_HEAVY_WEAPONS_1,
		"TRAIT_CY_HEAVY_WEAPONS_2" = TRAIT_CY_HEAVY_WEAPONS_2,
		"TRAIT_CY_HEAVY_WEAPONS_3" = TRAIT_CY_HEAVY_WEAPONS_3,
		"TRAIT_CY_HEAVY_WEAPONS_4" = TRAIT_CY_HEAVY_WEAPONS_4,
		"TRAIT_CY_HEAVY_WEAPONS_5" = TRAIT_CY_HEAVY_WEAPONS_5,
		"TRAIT_CY_HEAVY_WEAPONS_6" = TRAIT_CY_HEAVY_WEAPONS_6,
		"TRAIT_CY_GRAPPLING_1" = TRAIT_CY_GRAPPLING_1,
		"TRAIT_CY_GRAPPLING_2" = TRAIT_CY_GRAPPLING_2,
		"TRAIT_CY_GRAPPLING_3" = TRAIT_CY_GRAPPLING_3,
		"TRAIT_CY_GRAPPLING_4" = TRAIT_CY_GRAPPLING_4,
		"TRAIT_CY_GRAPPLING_5" = TRAIT_CY_GRAPPLING_5,
		"TRAIT_CY_GRAPPLING_6" = TRAIT_CY_GRAPPLING_6,
		"TRAIT_CY_TOUGHNESS_1" = TRAIT_CY_TOUGHNESS_1,
		"TRAIT_CY_TOUGHNESS_2" = TRAIT_CY_TOUGHNESS_2,
		"TRAIT_CY_TOUGHNESS_3" = TRAIT_CY_TOUGHNESS_3,
		"TRAIT_CY_TOUGHNESS_4" = TRAIT_CY_TOUGHNESS_4,
		"TRAIT_CY_TOUGHNESS_5" = TRAIT_CY_TOUGHNESS_5,
		"TRAIT_CY_TOUGHNESS_6" = TRAIT_CY_TOUGHNESS_6,
		"TRAIT_CY_FAST_MELEE_1" = TRAIT_CY_FAST_MELEE_1,
		"TRAIT_CY_FAST_MELEE_2" = TRAIT_CY_FAST_MELEE_2,
		"TRAIT_CY_FAST_MELEE_3" = TRAIT_CY_FAST_MELEE_3,
		"TRAIT_CY_FAST_MELEE_4" = TRAIT_CY_FAST_MELEE_4,
		"TRAIT_CY_FAST_MELEE_5" = TRAIT_CY_FAST_MELEE_5,
		"TRAIT_CY_FAST_MELEE_6" = TRAIT_CY_FAST_MELEE_6,
		"TRAIT_CY_LIGHT_WEAPONS_1" = TRAIT_CY_LIGHT_WEAPONS_1,
		"TRAIT_CY_LIGHT_WEAPONS_2" = TRAIT_CY_LIGHT_WEAPONS_2,
		"TRAIT_CY_LIGHT_WEAPONS_3" = TRAIT_CY_LIGHT_WEAPONS_3,
		"TRAIT_CY_LIGHT_WEAPONS_4" = TRAIT_CY_LIGHT_WEAPONS_4,
		"TRAIT_CY_LIGHT_WEAPONS_5" = TRAIT_CY_LIGHT_WEAPONS_5,
		"TRAIT_CY_LIGHT_WEAPONS_6" = TRAIT_CY_LIGHT_WEAPONS_6,
		"TRAIT_CY_ACROBATICS_1" = TRAIT_CY_ACROBATICS_1,
		"TRAIT_CY_ACROBATICS_2" = TRAIT_CY_ACROBATICS_2,
		"TRAIT_CY_ACROBATICS_3" = TRAIT_CY_ACROBATICS_3,
		"TRAIT_CY_ACROBATICS_4" = TRAIT_CY_ACROBATICS_4,
		"TRAIT_CY_ACROBATICS_5" = TRAIT_CY_ACROBATICS_5,
		"TRAIT_CY_ACROBATICS_6" = TRAIT_CY_ACROBATICS_6,
		"TRAIT_CY_EVASION_1" = TRAIT_CY_EVASION_1,
		"TRAIT_CY_EVASION_2" = TRAIT_CY_EVASION_2,
		"TRAIT_CY_EVASION_3" = TRAIT_CY_EVASION_3,
		"TRAIT_CY_EVASION_4" = TRAIT_CY_EVASION_4,
		"TRAIT_CY_EVASION_5" = TRAIT_CY_EVASION_5,
		"TRAIT_CY_EVASION_6" = TRAIT_CY_EVASION_6,
		"TRAIT_CY_PRECISE_MELEE_1" = TRAIT_CY_PRECISE_MELEE_1,
		"TRAIT_CY_PRECISE_MELEE_2" = TRAIT_CY_PRECISE_MELEE_2,
		"TRAIT_CY_PRECISE_MELEE_3" = TRAIT_CY_PRECISE_MELEE_3,
		"TRAIT_CY_PRECISE_MELEE_4" = TRAIT_CY_PRECISE_MELEE_4,
		"TRAIT_CY_PRECISE_MELEE_5" = TRAIT_CY_PRECISE_MELEE_5,
		"TRAIT_CY_PRECISE_MELEE_6" = TRAIT_CY_PRECISE_MELEE_6,
		"TRAIT_CY_THROWING_1" = TRAIT_CY_THROWING_1,
		"TRAIT_CY_THROWING_2" = TRAIT_CY_THROWING_2,
		"TRAIT_CY_THROWING_3" = TRAIT_CY_THROWING_3,
		"TRAIT_CY_THROWING_4" = TRAIT_CY_THROWING_4,
		"TRAIT_CY_THROWING_5" = TRAIT_CY_THROWING_5,
		"TRAIT_CY_THROWING_6" = TRAIT_CY_THROWING_6,
		"TRAIT_CY_WEAKSPOT_ANALYSIS_1" = TRAIT_CY_WEAKSPOT_ANALYSIS_1,
		"TRAIT_CY_WEAKSPOT_ANALYSIS_2" = TRAIT_CY_WEAKSPOT_ANALYSIS_2,
		"TRAIT_CY_WEAKSPOT_ANALYSIS_3" = TRAIT_CY_WEAKSPOT_ANALYSIS_3,
		"TRAIT_CY_WEAKSPOT_ANALYSIS_4" = TRAIT_CY_WEAKSPOT_ANALYSIS_4,
		"TRAIT_CY_WEAKSPOT_ANALYSIS_5" = TRAIT_CY_WEAKSPOT_ANALYSIS_5,
		"TRAIT_CY_WEAKSPOT_ANALYSIS_6" = TRAIT_CY_WEAKSPOT_ANALYSIS_6,
		"TRAIT_CY_CONCENTRATION_1" = TRAIT_CY_CONCENTRATION_1,
		"TRAIT_CY_CONCENTRATION_2" = TRAIT_CY_CONCENTRATION_2,
		"TRAIT_CY_CONCENTRATION_3" = TRAIT_CY_CONCENTRATION_3,
		"TRAIT_CY_CONCENTRATION_4" = TRAIT_CY_CONCENTRATION_4,
		"TRAIT_CY_CONCENTRATION_5" = TRAIT_CY_CONCENTRATION_5,
		"TRAIT_CY_CONCENTRATION_6" = TRAIT_CY_CONCENTRATION_6,
		"TRAIT_CY_IMPROVED_CODE_1" = TRAIT_CY_IMPROVED_CODE_1,
		"TRAIT_CY_IMPROVED_CODE_2" = TRAIT_CY_IMPROVED_CODE_2,
		"TRAIT_CY_IMPROVED_CODE_3" = TRAIT_CY_IMPROVED_CODE_3,
		"TRAIT_CY_IMPROVED_CODE_4" = TRAIT_CY_IMPROVED_CODE_4,
		"TRAIT_CY_IMPROVED_CODE_5" = TRAIT_CY_IMPROVED_CODE_5,
		"TRAIT_CY_IMPROVED_CODE_6" = TRAIT_CY_IMPROVED_CODE_6,
		"TRAIT_CY_FAST_CODE_1" = TRAIT_CY_FAST_CODE_1,
		"TRAIT_CY_FAST_CODE_2" = TRAIT_CY_FAST_CODE_2,
		"TRAIT_CY_FAST_CODE_3" = TRAIT_CY_FAST_CODE_3,
		"TRAIT_CY_FAST_CODE_4" = TRAIT_CY_FAST_CODE_4,
		"TRAIT_CY_FAST_CODE_5" = TRAIT_CY_FAST_CODE_5,
		"TRAIT_CY_FAST_CODE_6" = TRAIT_CY_FAST_CODE_6,
		"TRAIT_CY_HACKING_1" = TRAIT_CY_HACKING_1,
		"TRAIT_CY_HACKING_2" = TRAIT_CY_HACKING_2,
		"TRAIT_CY_HACKING_3" = TRAIT_CY_HACKING_3,
		"TRAIT_CY_HACKING_4" = TRAIT_CY_HACKING_4,
		"TRAIT_CY_HACKING_5" = TRAIT_CY_HACKING_5,
		"TRAIT_CY_HACKING_6" = TRAIT_CY_HACKING_6,
		"TRAIT_CY_INTELLIGENCE_COMPOSURE_1" = TRAIT_CY_INTELLIGENCE_COMPOSURE_1,
		"TRAIT_CY_INTELLIGENCE_COMPOSURE_2" = TRAIT_CY_INTELLIGENCE_COMPOSURE_2,
		"TRAIT_CY_INTELLIGENCE_COMPOSURE_3" = TRAIT_CY_INTELLIGENCE_COMPOSURE_3,
		"TRAIT_CY_INTELLIGENCE_COMPOSURE_4" = TRAIT_CY_INTELLIGENCE_COMPOSURE_4,
		"TRAIT_CY_INTELLIGENCE_COMPOSURE_5" = TRAIT_CY_INTELLIGENCE_COMPOSURE_5,
		"TRAIT_CY_INTELLIGENCE_COMPOSURE_6" = TRAIT_CY_INTELLIGENCE_COMPOSURE_6,
		"TRAIT_CY_SURVIVAL_1" = TRAIT_CY_SURVIVAL_1,
		"TRAIT_CY_SURVIVAL_2" = TRAIT_CY_SURVIVAL_2,
		"TRAIT_CY_SURVIVAL_3" = TRAIT_CY_SURVIVAL_3,
		"TRAIT_CY_SURVIVAL_4" = TRAIT_CY_SURVIVAL_4,
		"TRAIT_CY_SURVIVAL_5" = TRAIT_CY_SURVIVAL_5,
		"TRAIT_CY_SURVIVAL_6" = TRAIT_CY_SURVIVAL_6,
		"TRAIT_CY_SPIRIT_ENDURANCE_1" = TRAIT_CY_SPIRIT_ENDURANCE_1,
		"TRAIT_CY_SPIRIT_ENDURANCE_2" = TRAIT_CY_SPIRIT_ENDURANCE_2,
		"TRAIT_CY_SPIRIT_ENDURANCE_3" = TRAIT_CY_SPIRIT_ENDURANCE_3,
		"TRAIT_CY_SPIRIT_ENDURANCE_4" = TRAIT_CY_SPIRIT_ENDURANCE_4,
		"TRAIT_CY_SPIRIT_ENDURANCE_5" = TRAIT_CY_SPIRIT_ENDURANCE_5,
		"TRAIT_CY_SPIRIT_ENDURANCE_6" = TRAIT_CY_SPIRIT_ENDURANCE_6,
		"TRAIT_CY_ATHLETICS_1" = TRAIT_CY_ATHLETICS_1,
		"TRAIT_CY_ATHLETICS_2" = TRAIT_CY_ATHLETICS_2,
		"TRAIT_CY_ATHLETICS_3" = TRAIT_CY_ATHLETICS_3,
		"TRAIT_CY_ATHLETICS_4" = TRAIT_CY_ATHLETICS_4,
		"TRAIT_CY_ATHLETICS_5" = TRAIT_CY_ATHLETICS_5,
		"TRAIT_CY_ATHLETICS_6" = TRAIT_CY_ATHLETICS_6,
		"TRAIT_CY_COMPATIBILITY_1" = TRAIT_CY_COMPATIBILITY_1,
		"TRAIT_CY_COMPATIBILITY_2" = TRAIT_CY_COMPATIBILITY_2,
		"TRAIT_CY_COMPATIBILITY_3" = TRAIT_CY_COMPATIBILITY_3,
		"TRAIT_CY_COMPATIBILITY_4" = TRAIT_CY_COMPATIBILITY_4,
		"TRAIT_CY_COMPATIBILITY_5" = TRAIT_CY_COMPATIBILITY_5,
		"TRAIT_CY_COMPATIBILITY_6" = TRAIT_CY_COMPATIBILITY_6,
		"TRAIT_CY_STEALTH_1" = TRAIT_CY_STEALTH_1,
		"TRAIT_CY_STEALTH_2" = TRAIT_CY_STEALTH_2,
		"TRAIT_CY_STEALTH_3" = TRAIT_CY_STEALTH_3,
		"TRAIT_CY_STEALTH_4" = TRAIT_CY_STEALTH_4,
		"TRAIT_CY_STEALTH_5" = TRAIT_CY_STEALTH_5,
		"TRAIT_CY_STEALTH_6" = TRAIT_CY_STEALTH_6,
		"TRAIT_CY_THEFT_1" = TRAIT_CY_THEFT_1,
		"TRAIT_CY_THEFT_2" = TRAIT_CY_THEFT_2,
		"TRAIT_CY_THEFT_3" = TRAIT_CY_THEFT_3,
		"TRAIT_CY_THEFT_4" = TRAIT_CY_THEFT_4,
		"TRAIT_CY_THEFT_5" = TRAIT_CY_THEFT_5,
		"TRAIT_CY_THEFT_6" = TRAIT_CY_THEFT_6,
		"TRAIT_CY_INSPIRATION_1" = TRAIT_CY_INSPIRATION_1,
		"TRAIT_CY_INSPIRATION_2" = TRAIT_CY_INSPIRATION_2,
		"TRAIT_CY_INSPIRATION_3" = TRAIT_CY_INSPIRATION_3,
		"TRAIT_CY_INSPIRATION_4" = TRAIT_CY_INSPIRATION_4,
		"TRAIT_CY_INSPIRATION_5" = TRAIT_CY_INSPIRATION_5,
		"TRAIT_CY_INSPIRATION_6" = TRAIT_CY_INSPIRATION_6,
		"TRAIT_CY_STYLE_1" = TRAIT_CY_STYLE_1,
		"TRAIT_CY_STYLE_2" = TRAIT_CY_STYLE_2,
		"TRAIT_CY_STYLE_3" = TRAIT_CY_STYLE_3,
		"TRAIT_CY_STYLE_4" = TRAIT_CY_STYLE_4,
		"TRAIT_CY_STYLE_5" = TRAIT_CY_STYLE_5,
		"TRAIT_CY_STYLE_6" = TRAIT_CY_STYLE_6,
		"TRAIT_CY_MEDICINE_1" = TRAIT_CY_MEDICINE_1,
		"TRAIT_CY_MEDICINE_2" = TRAIT_CY_MEDICINE_2,
		"TRAIT_CY_MEDICINE_3" = TRAIT_CY_MEDICINE_3,
		"TRAIT_CY_MEDICINE_4" = TRAIT_CY_MEDICINE_4,
		"TRAIT_CY_MEDICINE_5" = TRAIT_CY_MEDICINE_5,
		"TRAIT_CY_MEDICINE_6" = TRAIT_CY_MEDICINE_6,
		"TRAIT_CY_CHEMISTRY_1" = TRAIT_CY_CHEMISTRY_1,
		"TRAIT_CY_CHEMISTRY_2" = TRAIT_CY_CHEMISTRY_2,
		"TRAIT_CY_CHEMISTRY_3" = TRAIT_CY_CHEMISTRY_3,
		"TRAIT_CY_CHEMISTRY_4" = TRAIT_CY_CHEMISTRY_4,
		"TRAIT_CY_CHEMISTRY_5" = TRAIT_CY_CHEMISTRY_5,
		"TRAIT_CY_CHEMISTRY_6" = TRAIT_CY_CHEMISTRY_6,
		"TRAIT_CY_ELECTRICITY_1" = TRAIT_CY_ELECTRICITY_1,
		"TRAIT_CY_ELECTRICITY_2" = TRAIT_CY_ELECTRICITY_2,
		"TRAIT_CY_ELECTRICITY_3" = TRAIT_CY_ELECTRICITY_3,
		"TRAIT_CY_ELECTRICITY_4" = TRAIT_CY_ELECTRICITY_4,
		"TRAIT_CY_ELECTRICITY_5" = TRAIT_CY_ELECTRICITY_5,
		"TRAIT_CY_ELECTRICITY_6" = TRAIT_CY_ELECTRICITY_6,
		"TRAIT_CY_CONSTRUCTION_1" = TRAIT_CY_CONSTRUCTION_1,
		"TRAIT_CY_CONSTRUCTION_2" = TRAIT_CY_CONSTRUCTION_2,
		"TRAIT_CY_CONSTRUCTION_3" = TRAIT_CY_CONSTRUCTION_3,
		"TRAIT_CY_CONSTRUCTION_4" = TRAIT_CY_CONSTRUCTION_4,
		"TRAIT_CY_CONSTRUCTION_5" = TRAIT_CY_CONSTRUCTION_5,
		"TRAIT_CY_CONSTRUCTION_6" = TRAIT_CY_CONSTRUCTION_6,
		"TRAIT_CY_INVENTION_1" = TRAIT_CY_INVENTION_1,
		"TRAIT_CY_INVENTION_2" = TRAIT_CY_INVENTION_2,
		"TRAIT_CY_INVENTION_3" = TRAIT_CY_INVENTION_3,
		"TRAIT_CY_INVENTION_4" = TRAIT_CY_INVENTION_4,
		"TRAIT_CY_INVENTION_5" = TRAIT_CY_INVENTION_5,
		"TRAIT_CY_INVENTION_6" = TRAIT_CY_INVENTION_6,
		"TRAIT_CY_ANALYSIS_1" = TRAIT_CY_ANALYSIS_1,
		"TRAIT_CY_ANALYSIS_2" = TRAIT_CY_ANALYSIS_2,
		"TRAIT_CY_ANALYSIS_3" = TRAIT_CY_ANALYSIS_3,
		"TRAIT_CY_ANALYSIS_4" = TRAIT_CY_ANALYSIS_4,
		"TRAIT_CY_ANALYSIS_5" = TRAIT_CY_ANALYSIS_5,
		"TRAIT_CY_ANALYSIS_6" = TRAIT_CY_ANALYSIS_6,
		"TRAIT_CY_MINING_1" = TRAIT_CY_MINING_1,
		"TRAIT_CY_MINING_2" = TRAIT_CY_MINING_2,
		"TRAIT_CY_MINING_3" = TRAIT_CY_MINING_3,
		"TRAIT_CY_MINING_4" = TRAIT_CY_MINING_4,
		"TRAIT_CY_MINING_5" = TRAIT_CY_MINING_5,
		"TRAIT_CY_MINING_6" = TRAIT_CY_MINING_6,
		"TRAIT_CY_DRIVING_1" = TRAIT_CY_DRIVING_1,
		"TRAIT_CY_DRIVING_2" = TRAIT_CY_DRIVING_2,
		"TRAIT_CY_DRIVING_3" = TRAIT_CY_DRIVING_3,
		"TRAIT_CY_DRIVING_4" = TRAIT_CY_DRIVING_4,
		"TRAIT_CY_DRIVING_5" = TRAIT_CY_DRIVING_5,
		"TRAIT_CY_DRIVING_6" = TRAIT_CY_DRIVING_6,
		"TRAIT_CY_COOKING_1" = TRAIT_CY_COOKING_1,
		"TRAIT_CY_COOKING_2" = TRAIT_CY_COOKING_2,
		"TRAIT_CY_COOKING_3" = TRAIT_CY_COOKING_3,
		"TRAIT_CY_COOKING_4" = TRAIT_CY_COOKING_4,
		"TRAIT_CY_COOKING_5" = TRAIT_CY_COOKING_5,
		"TRAIT_CY_COOKING_6" = TRAIT_CY_COOKING_6,
		"TRAIT_CY_GARDENING_1" = TRAIT_CY_GARDENING_1,
		"TRAIT_CY_GARDENING_2" = TRAIT_CY_GARDENING_2,
		"TRAIT_CY_GARDENING_3" = TRAIT_CY_GARDENING_3,
		"TRAIT_CY_GARDENING_4" = TRAIT_CY_GARDENING_4,
		"TRAIT_CY_GARDENING_5" = TRAIT_CY_GARDENING_5,
		"TRAIT_CY_GARDENING_6" = TRAIT_CY_GARDENING_6,
		"TRAIT_CY_MUSIC_1" = TRAIT_CY_MUSIC_1,
		"TRAIT_CY_MUSIC_2" = TRAIT_CY_MUSIC_2,
		"TRAIT_CY_MUSIC_3" = TRAIT_CY_MUSIC_3,
		"TRAIT_CY_MUSIC_4" = TRAIT_CY_MUSIC_4,
		"TRAIT_CY_MUSIC_5" = TRAIT_CY_MUSIC_5,
		"TRAIT_CY_MUSIC_6" = TRAIT_CY_MUSIC_6,
		...
		"TRAIT_ADVANCED_RCD_KNOWLEDGE" = TRAIT_ADVANCED_RCD_KNOWLEDGE, //BANDASTATION ADD - Engineer Skillchip RCD
		...
		"TRAIT_NO_CRIT_UNCONSCIOUS" = TRAIT_NO_CRIT_UNCONSCIOUS,
