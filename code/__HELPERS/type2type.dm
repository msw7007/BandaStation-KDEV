...
/proc/body_zone2cover_flags(def_zone)
	switch(def_zone)
		...
		if(BODY_ZONE_PRECISE_GROIN)
			return GROIN
		if(BODY_ZONE_HEAD, BODY_ZONE_PRECISE_EYES, BODY_ZONE_PRECISE_MOUTH, BODY_ZONE_PRECISE_NOSE, BODY_ZONE_PRECISE_EARS, BODY_ZONE_PRECISE_NECK)
			return HEAD
		if(BODY_ZONE_L_ARM)
...
/proc/cover_flags2body_zones(bpc)
	...
	if(bpc & HEAD)
		covered_parts |= list(BODY_ZONE_HEAD, BODY_ZONE_PRECISE_EYES, BODY_ZONE_PRECISE_MOUTH, BODY_ZONE_PRECISE_NOSE, BODY_ZONE_PRECISE_EARS, BODY_ZONE_PRECISE_NECK)
