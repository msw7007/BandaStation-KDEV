...
/datum/brain_trauma/special/genetic_tumor
	name = "Genetic Tumor"
	desc = "A self-developing genetic lesion left by a visceroid collapse."
	scan_desc = "genetic tumor"
	symptoms = "relapsing genetic collapse"
	gain_text = span_warning("Something inside your brain begins to grow in the wrong direction.")
	lose_text = span_notice("The pressure of the genetic tumor recedes.")
	random_gain = FALSE
...
/datum/brain_trauma/special/genetic_tumor/New(dormant_time = GENETIC_TUMOR_DORMANT_TIME)
	. = ..()
	dormant_until = world.time + dormant_time
	next_severity_shift = world.time + GENETIC_TUMOR_SEVERITY_INTERVAL

/datum/brain_trauma/special/genetic_tumor/proc/reset_dormancy(dormant_time = GENETIC_TUMOR_DORMANT_TIME)
	growth = 0
	dormant_until = world.time + dormant_time
	next_severity_shift = world.time + GENETIC_TUMOR_SEVERITY_INTERVAL

/datum/brain_trauma/special/genetic_tumor/on_life(seconds_per_tick)
