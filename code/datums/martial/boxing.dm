...
/datum/martial_art/boxing/proc/tussle(mob/living/attacker, mob/living/defender)
	...
	if(honor_check(defender))
		...
		var/obj/item/organ/cyberimp/chest/spine/potential_spine = attacker.get_cyberpunk_spine_implant() //Getting a cyberspine also pushes you further than just mere meat
