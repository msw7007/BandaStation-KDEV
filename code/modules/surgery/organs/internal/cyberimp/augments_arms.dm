...
/obj/item/organ/cyberimp/arm/strongarm/proc/on_attack_hand(mob/living/carbon/human/source, atom/target, proximity, modifiers)
	...
	*/
	...
	var/potential_lower_damage = min(attacking_bodypart.unarmed_damage_low + (source.get_cy_skill_perk_level(/datum/cy_skill/spirit/athletics) || 0), potential_upper_damage)
