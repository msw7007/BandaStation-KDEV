...
// BANDASTATION EDIT START: NEW CHEMS
		if(reagent.overdose_critical_health_threshold)
			if(reagent.volume >= reagent.overdose_critical_health_threshold)
			...
			if(reagent.volume < reagent.overdose_critical_health_threshold && reagent.overdosed_crit && reagent.overdose_critical_health_threshold)
