...
/mob/living/simple_animal/hostile/megafauna/bubblegum/adjust_brute_loss(amount, updating_health = TRUE, forced = FALSE, required_bodytype, brute_type = BODYPART_DAMAGE_BLUNT)
	. = ..()
...
/mob/living/simple_animal/hostile/megafauna/bubblegum/hallucination/adjust_brute_loss(amount, updating_health = TRUE, forced = FALSE, required_bodytype, brute_type = BODYPART_DAMAGE_BLUNT)
	return
