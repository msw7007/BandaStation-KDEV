...
// BANDASTATION EDIT START - gygax mech core
...
// BANDASTATION EDIT START - durand mech core
...
/datum/component/construction/mecha/phazon/get_stockpart_steps()
	return list(
		...
		list(
			...
			"amount" = 1,
			"back_key" = TOOL_SCREWDRIVER,
			"desc" = "Servo is secured, and the <b>rift crystal</b> can be added.",
			"forward_message" = "added rift crystal",
			"backward_message" = "unsecured servo",
		),
		list(
			"key" = /obj/item/stack/cable_coil,
			"amount" = 5,
			"back_key" = TOOL_CROWBAR,
			"desc" = "The rift crystal is installed, and can be <b>wired</b> to the mech systems.",
			"forward_message" = "connected rift crystal",
			"backward_message" = "removed rift crystal",
			"icon_state" = "phazon19",
		),
		list(
			"key" = TOOL_SCREWDRIVER,
			"back_key" = TOOL_WIRECUTTER,
			"desc" = "The rift crystal is connected, and the system can be engaged with a <b>screwdriver</b>.",
			"forward_message" = "engaged rift crystal",
			"backward_message" = "disconnected rift crystal",
			"icon_state" = "phazon20",
		),
		list(
			"key" = /obj/item/stock_parts/power_store/cell,
			"action" = ITEM_MOVE_INSIDE,
			"back_key" = TOOL_SCREWDRIVER,
			"desc" = "The rift crystal is engaged, and the <b>power cell</b> can be added.",
			"forward_message" = "added power cell",
			"backward_message" = "disengaged rift crystal",
			"icon_state" = "phazon21",
		),
		list(
			"key" = TOOL_SCREWDRIVER,
...
/datum/component/construction/mecha/phazon/get_outer_plating_steps()
	return ..() + list(
		...
		// BANDASTATION EDIT START - phazon mech core
		list(
			"key" = /obj/item/mecha_parts/core,
			"action" = ITEM_DELETE,
			"back_key" = TOOL_WELDER,
...
// BANDASTATION EDIT START - savannah_ivanov mech core
