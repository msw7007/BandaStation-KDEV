...
// CYBERPUNK MODULARITY moved to code/modules/cyberpunk/modularity/items/*.dm.
// Keep only /obj/item vars in this root file; behavior, components, modules and designs live in the modularity layer.
