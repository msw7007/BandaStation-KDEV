	...
	switch(dir)
		if(NORTH,SOUTH)
			if(unres_sides & NORTH)
				...
				apply_hires_legacy_appearance(side_overlay)
				side_overlay.color = LIGHT_COLOR_DEFAULT
				side_overlay.pixel_z = (dir == NORTH ? 31 : 6) * (ICON_SIZE_Y / LEGACY_ICON_SIZE_Y)
				. += side_overlay
			if(unres_sides & SOUTH)
				...
				apply_hires_legacy_appearance(side_overlay)
				side_overlay.color = LIGHT_COLOR_DEFAULT
				side_overlay.pixel_z = (dir == NORTH ? -6 : -31) * (ICON_SIZE_Y / LEGACY_ICON_SIZE_Y)
				. += side_overlay
		if(EAST,WEST)
			if(unres_sides & EAST)
				...
				apply_hires_legacy_appearance(side_overlay)
				side_overlay.color = LIGHT_COLOR_DEFAULT
				side_overlay.pixel_w = (dir == EAST ? 31 : 6) * (ICON_SIZE_X / LEGACY_ICON_SIZE_X)
				. += side_overlay
			if(unres_sides & WEST)
				...
				apply_hires_legacy_appearance(side_overlay)
				side_overlay.color = LIGHT_COLOR_DEFAULT
				side_overlay.pixel_w = (dir == EAST ? -6 : -31) * (ICON_SIZE_X / LEGACY_ICON_SIZE_X)
				. += side_overlay
