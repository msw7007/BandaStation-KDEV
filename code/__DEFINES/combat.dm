...
#define CY_DEFENSE_WINDOW (3 SECONDS)
#define CY_DEFENSE_BASE_SUCCESS_CHANCE 25
#define CY_DODGE_PERK_SUCCESS_BONUS 5
#define CY_PARRY_PERK_SUCCESS_BONUS 5
#define CY_PARRY_SUCCESS_RESIST_TIME (2 SECONDS)
#define CY_PARRY_SUCCESS_DAMAGE_MULTIPLIER 0.5
