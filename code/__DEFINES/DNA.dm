...
#define ORGAN_SLOT_EXTERNAL_PENIS "penis"
#define ORGAN_SLOT_EXTERNAL_TESTICLES "testicles"
#define ORGAN_SLOT_EXTERNAL_BUTT "butt"
#define ORGAN_SLOT_EXTERNAL_BELLY "belly"
#define ORGAN_SLOT_EXTERNAL_VAGINA "vagina"
#define ORGAN_SLOT_EXTERNAL_ANUS "anus"
...
GLOBAL_LIST_INIT(organ_process_order, list(
	...
	ORGAN_SLOT_EXTERNAL_BREASTS,
	ORGAN_SLOT_EXTERNAL_PENIS,
	ORGAN_SLOT_EXTERNAL_TESTICLES,
	ORGAN_SLOT_EXTERNAL_BUTT,
	ORGAN_SLOT_EXTERNAL_BELLY,
	ORGAN_SLOT_EXTERNAL_VAGINA,
	ORGAN_SLOT_EXTERNAL_ANUS,
))
