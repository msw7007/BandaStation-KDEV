...
/datum/controller/subsystem/accessories/proc/setup_lists()
	...
	var/list/human_tattoos = INIT_OPTIONAL_ACCESSORY(/datum/sprite_accessory/human_tattoo)
	for(var/tattoo_feature in list(
		FEATURE_HUMAN_TATTOO_HEAD_1, FEATURE_HUMAN_TATTOO_HEAD_2, FEATURE_HUMAN_TATTOO_HEAD_3, FEATURE_HUMAN_TATTOO_HEAD_4, FEATURE_HUMAN_TATTOO_HEAD_5, FEATURE_HUMAN_TATTOO_HEAD_6,
		FEATURE_HUMAN_TATTOO_CHEST_1, FEATURE_HUMAN_TATTOO_CHEST_2, FEATURE_HUMAN_TATTOO_CHEST_3, FEATURE_HUMAN_TATTOO_CHEST_4, FEATURE_HUMAN_TATTOO_CHEST_5, FEATURE_HUMAN_TATTOO_CHEST_6,
		FEATURE_HUMAN_TATTOO_L_ARM_1, FEATURE_HUMAN_TATTOO_L_ARM_2, FEATURE_HUMAN_TATTOO_L_ARM_3, FEATURE_HUMAN_TATTOO_L_ARM_4, FEATURE_HUMAN_TATTOO_L_ARM_5, FEATURE_HUMAN_TATTOO_L_ARM_6,
		FEATURE_HUMAN_TATTOO_R_ARM_1, FEATURE_HUMAN_TATTOO_R_ARM_2, FEATURE_HUMAN_TATTOO_R_ARM_3, FEATURE_HUMAN_TATTOO_R_ARM_4, FEATURE_HUMAN_TATTOO_R_ARM_5, FEATURE_HUMAN_TATTOO_R_ARM_6,
		FEATURE_HUMAN_TATTOO_L_LEG_1, FEATURE_HUMAN_TATTOO_L_LEG_2, FEATURE_HUMAN_TATTOO_L_LEG_3, FEATURE_HUMAN_TATTOO_L_LEG_4, FEATURE_HUMAN_TATTOO_L_LEG_5, FEATURE_HUMAN_TATTOO_L_LEG_6,
		FEATURE_HUMAN_TATTOO_R_LEG_1, FEATURE_HUMAN_TATTOO_R_LEG_2, FEATURE_HUMAN_TATTOO_R_LEG_3, FEATURE_HUMAN_TATTOO_R_LEG_4, FEATURE_HUMAN_TATTOO_R_LEG_5, FEATURE_HUMAN_TATTOO_R_LEG_6,
	))
		feature_list[tattoo_feature] = human_tattoos
